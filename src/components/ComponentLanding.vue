<template>
          ...
          <div class="col-lg-12">
            <nav class="navbar navbar-expand-lg">
              <a class="navbar-brand logo" href="index.html">
                <img class="logo1" src="../assets/landing/images/logo/Logo.svg" alt="Logo"/>
              </a>
    ...
    <div class="container">
      ...
      <div class="single-head">
        <img class="service-patern wow fadeInLeft" data-wow-delay=".5s"
             src="../assets/landing/images/service/service-patern.png" alt="#">
        <div class="row">
          <div class="col-lg-3 col-md-6 col-12">
            <div class="single-service wow fadeInUp tgc" data-wow-delay=".2s">
              ...
              <p>Победители конкурсов на лучшую бульбу белоруси</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-12">
            <div class="single-service wow fadeInUp tgc" data-wow-delay=".4s">
              ...
              <p>Картинка на мину похожа, мы продаем оружие?(ну почему бы и нет)</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-12">
            <div class="single-service wow fadeInUp tgc" data-wow-delay=".6s">
              ...
              <p>Настолько быстро вас нахуй не посылали никогда</p>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-12">
  ...
  <!--как это работает-->
  <section id="how_it_works" class="about-us section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 col-12">
          <div class="about-right wow fadeInRight" data-wow-delay=".4s">
            <img src="../assets/landing/images/about/baba.jpg" alt="#">
          </div>
        </div>
      </div>
    </div>
  ...
  <!--стать фермером-->
  <section id="start_fermer_carrier" class="intro-video-area overlay section">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <div class="section-title white-text">
            <h2 class="wow fadeInUp" data-wow-delay=".4s">Хочешь стать фермером?</h2>
            <p class="wow fadeInUp" data-wow-delay=".6s">Здесь ты можешь узнать, как за пару минут стать одним из нашей
              команды фермеров.</p>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-12">
          <div class="intro-video-play">
            <div class="carousel-3d">
              <figure>
                <div><a href="#any"><img src="../assets/landing/images/hero/her.jpg" alt=""/></a></div>
                <div><a href="#any"><img src="../assets/landing/images/hero/her.jpg" alt=""/></a></div>
                <div><a href="#any"><img src="../assets/landing/images/hero/her.jpg" alt=""/></a></div>
                <div><a href="#any"><img src="../assets/landing/images/hero/her.jpg" alt=""/></a></div>
                <div><a href="#any"><img src="../assets/landing/images/hero/her.jpg" alt=""/></a></div>
            ...
            <div class="accordion " id="accordionExample">
              ...
              <div class="card">
                ...
                <div id="collapseThree" class="collapse fade" aria-labelledby="headingThree"
                     data-parent="#accordionExample">
                  <div class="card-body">
                    Записываете номер телефона, вам ghb[jlbn rjl rjl ds tuj dgbcsdftnt d dscdtntdijtcz jryj b djn b dct
                    rjulf rnj-nj gjgsnftncz djqnb yf frrfeyn ,tp dfituj dtljvf dfv ghbltn edtljvktybt(ну да,ну да пошел
                    я нахер)
                  </div>
                </div>
              </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-12">
            ...
            <div class="f-about single-footer">
              <div class="logo">
                <a href="index.html"><img src="../assets/landing/images/logo/footer-logo.svg" alt="Logo"></a>
              </div>
  ...
  <!--  <script src="../assets/landing/js/count-up.min.js"></script>-->
  ...
  <!--  <script src="../assets/landing/js/imagesloaded.min.js"></script>-->
...
export default {
  ...
  setup() {
    ...
    scriptsPath.forEach(scriptPath => {
